...
class mpgResponse
{
	...
	{
	 	return isset($this->responseData['status_code']) ? $this->responseData['status_code'] : null;
	}

	function getStatusMessage()
	{
	 	return isset($this->responseData['status_message']) ? $this->responseData['status_message'] : null;
	}
	...
	function getTicket()
	{
 		return isset($this->responseData['Ticket']) ? $this->responseData['Ticket'] : null;
	}
	...
	{
		return isset($this->responseData['IsVisaDebit']) ? $this->responseData['IsVisaDebit'] : null;
	}
...
class mpgTransaction
{
	...
	var $ach = null;
	var $convFee = null;
        var $sessionAccountInfo;
        var $attributeAccountInfo;
