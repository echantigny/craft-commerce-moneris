...
/**
 * Moneris Update Credit Card Request.
 */
 ...
 * the full card details. Moneris also works directly with card networks
 * so that your customers can continue using your service without
 * interruption.
 *
 * When you update a card, Moneris will automatically validate the card.
 *
